...
import com.nurs_projects.springjsrest.dao.UserDAO;
    ...
    public void saveUser(User user) {
        ...
        try {
            if (userDAO.getUserByUsername(user.getUsername()) != null) {
                throw new NonUniqueResultException("Error. Username '" + user.getUsername() + "' exists already.");
            }
    ...
    public void updateUser(User user) {
        ...
        try {
            ...
            if (!Objects.equals(daouserId, user.getId())) {
                throw new NonUniqueResultException("Error.Username '" + user.getUsername() +  "' already exists.");
            }
        } catch (EmptyResultDataAccessException | NoResultException ignored) {
        }
